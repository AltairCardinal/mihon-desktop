...
object DesktopSettingsCatalog {
    fun screens(): List<SearchableSettingsScreen<Screen>> = listOf(
        ...
        screen(DownloadSettingsScreen(), MR.strings.pref_category_downloads, MR.strings.pref_download_new, MR.strings.save_chapter_as_cbz),
        ...
        screen(BackupSettingsScreen(), MR.strings.label_backup, MR.strings.pref_create_backup, MR.strings.pref_restore_backup),
