...
class RealExtensionComicFuryTextCompatTest {
                ...
                try {
                    ...
                    try {
                        MockWebServer().also { it.start() }.use { server ->
                            ...
                            val repeatedShort = render(source, shortPage)
                            ...
                            assertEquals(short.darkBounds, repeatedShort.darkBounds, "Canvas translation accumulated")
                        }
                    } finally {
    ...
    private fun BufferedImage.inspect(): RenderedNote {
        ...
        return RenderedNote(width, height, white, dark, listOf(minX, minY, maxX, maxY))
    }
    ...
    private fun chapterHtml(note: String) = """
        <div class="is--comic-page"><img src="https://example.invalid/page.png"><div class="is--author-notes"><div class="is--comment-box"><span class="is--comment-author">Ada</span><div class="is--comment-content">$note</div></div></div></div>
    """
