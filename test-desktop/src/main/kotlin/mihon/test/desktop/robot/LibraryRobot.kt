...
class ReaderRobot(private val client: DesktopTestClient) {
    ...
    fun nextPage(): ReaderRobot {
        client.executeAction("reader_next_page")
        return this
    }
    ...
    fun prevPage(): ReaderRobot {
        client.executeAction("reader_prev_page")
        return this
    }
    ...
    fun nextChapter(): ReaderRobot {
        client.executeAction("reader_next_chapter")
        return this
    }
    ...
    fun prevChapter(): ReaderRobot {
        client.executeAction("reader_prev_chapter")
        return this
    }
     ...
     * Set reading mode.
     */
    fun setMode(mode: String): ReaderRobot {
        client.executeAction("reader_mode", mapOf("mode" to mode))
        return this
    }
     ...
     * Zoom in.
     */
    fun zoomIn(): ReaderRobot {
        client.executeAction("reader_zoom", mapOf("delta" to 0.1f))
        return this
    }
     ...
     * Zoom out.
     */
    fun zoomOut(): ReaderRobot {
        client.executeAction("reader_zoom", mapOf("delta" to -0.1f))
        return this
    }

    /**
     * Capture screenshot of reader.
     */
    fun capture(name: String = "reader"): ScreenshotResult {
        return client.screenshot(name)
    }
}
